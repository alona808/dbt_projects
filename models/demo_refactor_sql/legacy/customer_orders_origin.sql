/*
This is the original file that should be refactored. It is left here for reference and comparison.
The database dbt-tutorial  is a remote project  that can be accessed on BigQuery. The refactored version of this file is customer_orders_refactored.sql
*/
